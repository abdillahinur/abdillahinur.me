        ...
        <Card>
          ...
          <CardContent>
            <ul className="list-disc pl-4 space-y-2">
              ...
              <li>Collaborated with cross-functional teams to integrate new features into the CRA&apos;ms My Account portal, the primary platform for millions of Canadians to access and manage tax information.</li>
            </ul>
          </CardContent>
        </Card>
